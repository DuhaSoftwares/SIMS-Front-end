...
import { CustomerService } from '../../../services/people-services/customer.service';
...
export class CustomerComponent extends BaseComponent<CustomerViewModel> implements OnInit{
  constructor(commonService: CommonService, exceptionHandler: LogHandlerService,private customerService:CustomerService, public themeService: CustomizerSettingsService, private fb: FormBuilder) {
