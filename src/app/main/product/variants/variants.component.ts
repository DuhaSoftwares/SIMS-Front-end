...
import { VariantService } from '../../../services/product-services/variants.service';
...
export class VariantsComponent extends BaseComponent<VariantViewModel> implements OnInit{
  constructor(commonService: CommonService, exceptionHandler: LogHandlerService,private variantsService:VariantService, public themeService: CustomizerSettingsService, private fb: FormBuilder) {
